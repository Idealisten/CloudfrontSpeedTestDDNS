...
# 使用代理，克隆 GitHub 项目，如果你的代理不同请自行修改
git clone https://github.com/hello-earth/cloudflare-better-ip.git \
    -c http.https://github.com.proxy="socks5://192.168.4.1:1070"


python3 download_ip.py
...
python3 cf_ddns/cf_dns_tgpush.py
